    ...
    >
      ...
      <section className="py-24 px-6 lg:px-12 bg-background-light dark:bg-background-dark">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="font-display text-4xl text-gray-900 dark:text-white mb-4">Sélections</h2>
            ...
            {[
              ...
              >
                ...
                <div className="absolute bottom-8 left-8">
                  ...
                  <span className="text-white/80 text-xs uppercase tracking-widest border-b border-white/30 group-hover:border-white transition-all">Découvrir</span>
                </div>
              </MotionLink>
            ))}
          </motion.div>
